...
export const SupplierLeadsTable = ({ leads, formatDate, onEditLead }: SupplierLeadsTableProps) => {
  return (
            ...
            leads.map((lead) => (
              <TableRow key={lead.id}>
                ...
                <TableCell className="text-xs text-center">
                  <AIInteractionsCount calls={lead.calls} lead={lead} formatDate={formatDate} />
                </TableCell>
